export default {
    ...
    config: {
        ...
        duplicate: {
            ...
            title: "Cấu hình cảnh báo tương tác trùng nội dung",
    ...
    sms_types: {
        ...
        placeholder: {
            ...
            description: "Nhập mô tả",
            group: "Chọn nhóm tin",
            alias: "Alias phân cách nhau bởi dấu ;",
            prefix: "Prefix phân cách nhau bởi dấu ;",
            priority: "Độ ưu tiên"
        },
        datatable: {
    ...
    report_block: {
        alias: {
            datatable: {
                title: "Danh sách chặn theo alias",
                columns: {
                    date: "Ngày",
                    type_name: "Loại tin",
                    out_of_time_frame: "Gửi tin ngoài khung giờ cho phép",
                    out_of_time_frame_customer:
                        "Số lượng khách hàng gửi tin ngoài khung giờ cho phép",
                    segment_day: "Gửi tin quá số lượng tối đa/ngày",
                    segment_day_customer:
                        "Số lượng KH gửi tin quá số lượng tối đa/ngày",
                    segment_month: "Gửi tin quá số lượng tối đa/30 ngày",
                    segment_month_customer:
                        "Số lượng KH gửi tin quá số lượng tối đa/30 ngày"
                }
            }
        },
        segment: {
            datatable: {
                title: "Danh sách chặn theo phân khúc",
                columns: {
                    date: "Ngày",
                    reason: "Nguyên nhân chặn",
                    type_name: "Loại tin",
                    vip_sms: "Số lượng tin VIP",
                    vip_customer: "Số lượng KH VIP",
                    potential_sms: "Số lượng tin TN",
                    potential_customer: "Số lượng KH TN",
                    normal_sms: "Số lượng tin ĐT",
                    normal_customer: "Số lượng KH ĐT"
                }
            }
        }
    }
