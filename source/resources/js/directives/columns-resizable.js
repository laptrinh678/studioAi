export default {
    mounted(el) {
        ...
        const barHeight = nodeName === 'thead' ? table.offsetHeight : thead.offsetHeight;
        ...
        ths.forEach((th, index) => {
            ...
            bar.style.left = nextTh.offsetLeft - 3 + 'px';
            bar.style.top = 0;
        ...
        thead.addEventListener('mouseover', () => {
        ...
        const handleResize = (e) => {
            if (moving) {
                ...
                bar.style.left = nextTh.offsetLeft + e.movementX + 'px';
            }
        };
