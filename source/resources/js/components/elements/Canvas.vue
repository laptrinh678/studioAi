...
<div class="flex-row">
    <div class="source">
        ...
        <select v-model="strokeType">
            <option value="dash">Tự do</option>
            <option value="line">Đường thẳng</option>
            <option value="circle">Hình tròn</option>
            <option value="square">Hình vuông</option>
            <option value="triangle">Tam giác</option>
            <option value="half_triangle">Tam giác vuông</option>
        </select>
        <select v-model="lineCap">
            <option value="butt">Mặc định</option>
            <option value="round">Bo tròn 2 đầu</option>
            <option value="square">Bo vuông 2 đầu</option>
        </select>
        <select v-model="lineJoin">
            <option value="miter">Mặc định</option>
            <option value="round">Bo tròn các góc</option>
            <option value="bevel">Bo vuông các góc</option>
        </select>
